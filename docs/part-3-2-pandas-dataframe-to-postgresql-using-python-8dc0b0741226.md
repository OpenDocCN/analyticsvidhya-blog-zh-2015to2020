# 第 3.2 部分！！使用 Python 将数据帧转换为 PostgreSQL

> 原文：<https://medium.com/analytics-vidhya/part-3-2-pandas-dataframe-to-postgresql-using-python-8dc0b0741226?source=collection_archive---------5----------------------->

## 使用 execute_batch()将批量数据插入 PostgreSQL 数据库

![](img/13663fd78ba44c9ab04a8d79ad7dc7cb.png)
...
本文的主要目标是逐步学习***execute _ batch()***方法的工作代码。
...
**import** psycopg2.extras **as** extrasimport pandas as pd
...
def connect(conn_params_dic):**
    ...
    try:
        ...
        **# passing exception to function**
        ...
        conn = None
    return conn***# Define function using psycopg2.extras.execute_batch() to insert* the dataframe**
...
***# Run the execute_batch method, using table irisExecuteBatch***
execute_batch(conn, irisData, 'irisExecuteBatch')
```
...
```
***# Prepare sql query***
sql = "SELECT * FROM irisExecuteBatch" 
***# Execute cursor*** cursor.execute(sql)
...
![](img/2fcbfaa65f4d8d666f805cf8329de53a.png)

**结论:**我们的**部分 3.2** 到此结束。在本教程中，我们学习了如何使用***execute _ batch()***方法将批量数据插入 PostgreSQL 数据库。

本文的所有代码都可以作为 GitHub *上的 [***Jupyter 笔记本获得。***](https://github.com/Muhd-Shahid/Learn-Python-Data-Access/tree/main/PostgreSQL)*

> **接下来** [**第 3.3 部分**](/analytics-vidhya/part-3-3-pandas-dataframe-to-postgresql-using-python-57e68fe39385) **:使用 Python 将使用 execute_values()方法的批量数据插入 PostgreSQL 数据库。**
> 
> ***之前的学习:***
> 
