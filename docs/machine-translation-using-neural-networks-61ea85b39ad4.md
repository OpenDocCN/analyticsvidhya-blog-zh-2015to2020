...
这里，当 X1 被前馈到神经网络中时，它也接收来自输入 X0 的激活函数的信息。这就是递归神经网络的特殊性和唯一性。现在让我们看看具有多个隐藏层的递归神经网络。
...
![](img/3f2aa5c6272b40c4553d393d4c46efb3.png)
...
这就是它如何预测剩下的单词，在预测完单词后，它会给我们一个句尾标记。这里
